...
import { verifyCodexSchema, verifyGeneratedSchemaDirectory } from '../ai/verify-codex-schema.mjs';

const AI_ROOT = join(fileURLToPath(new URL('.', import.meta.url)), '..', 'ai');
const BASELINE_PATH = join(AI_ROOT, 'codex-protocol-baseline.json');
