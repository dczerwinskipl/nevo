...
import type { DashboardChange, DashboardTask, SpecificationOwnerAction } from '@/lib/types';
 ...
 * primitives. Extracted out of `SpecDetail` so that component is left to compose page
