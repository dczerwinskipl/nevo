...
test('Antigravity ask mode contract simulation: provider correctly processes blocked mutation tool failure in plan mode', async () => {
...
test('Antigravity raw capture: disabled by default and normal provider turn does not touch .nevo-ai-local/antigravity_raw', async () => {
