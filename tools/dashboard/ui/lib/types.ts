...
// Agent Session (AI provider/turn/transcript/interaction) types live in
// features/agent-sessions/types.ts — this file only keeps types shared by the
// remaining, not-yet-migrated dashboard features (Specs, Pull Requests, Operations).
