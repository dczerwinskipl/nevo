...
export function buildProgram() {
  ...
  step.command('finish')
    ...
    .option('--title <text>', '(Obsolete) Use --input or --input-file instead')
    .option('--message <text>', '(Obsolete) Use --input or --input-file instead')
    .option('--include <patterns>', '(Obsolete) Use --input or --input-file instead')
    .option('--exclude <patterns>', '(Obsolete) Use --input or --input-file instead')
    .option('--result <value>', '(Obsolete) Use --input or --input-file instead')
