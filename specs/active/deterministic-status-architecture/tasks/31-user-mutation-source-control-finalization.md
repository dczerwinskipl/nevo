...
`operation-record.mjs` — this task only calls their existing, genuinely-exported functions,
never edits them. Retroactively re-classifying every other existing dashboard action against
the new taxonomy.
