...
semantic_references:
  ...
  constraints: [C4, C7, C8, C9, C10, C11, C12, C13, C17, C18]
...
- Resolve permissions/questions and cancel through POST requests with validated normalized bodies and bounded sizes.
...
5. Permission and question response bodies correlate the exact turn/interaction and reject duplicates, mismatches, traversal, malformed JSON, and oversized input. `automated: npm --prefix tools/dashboard test`
